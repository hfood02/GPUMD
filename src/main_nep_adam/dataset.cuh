...
public:
  ...
  std::vector<float> error_cpu; // error in energy, virial, or force (squared)
  GPU_Vector<float> error_gpu;  // error in energy, virial, or force (squared)
  GPU_Vector<float> diff_gpu; // error in energy or force (before squared)
  GPU_Vector<float> diff_gpu_virial; // error in virial (before squared)
  ...
  std::vector<float> get_rmse_force(Parameters& para, const bool use_weight, const bool require_grad, int device_id);
  std::vector<float> get_rmse_energy(
    Parameters& para,
    const bool use_weight,
    const bool require_grad,
    int device_id);
  std::vector<float> get_rmse_virial(Parameters& para, const bool use_weight, const bool require_grad, int device_id);
